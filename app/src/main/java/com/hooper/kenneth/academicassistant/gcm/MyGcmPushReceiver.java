package com.hooper.kenneth.academicassistant.gcm;
    ...
    public void onMessageReceived(String from, Bundle bundle) {
        ...
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            ...
            if(LogInActivity.loggedInUserType) {
                c = ChooseConversationLecturerActivity.class;
            } else {
                c = ChooseConversationStudentActivity.class;
            }
            Intent resultIntent = new Intent(getApplicationContext(), c);
